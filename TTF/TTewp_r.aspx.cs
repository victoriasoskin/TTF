...
namespace TTF
{
    public partial class TTewp_r : System.Web.UI.Page
    {
        ...
        protected void Page_PreInit(object sender, EventArgs e)
        {
            ...
            h = new TTF.App_Code.bpHelber(Page, cFormTypeId, cCustEventTypeId);// 7,135);
            h.lvMP = lvMP;
        ...
        public TTewp_r()
        {
            //h = new TTF.App_Code.bpHelber(Page,h.FormTypeId,h.CustEventTypeId);// 7,135);
            //h.lvMP = lvMP;
            //h.LVWeeklyPlan = LVWeeklyPlan;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            h.CustEventTypeId = cCustEventTypeId;//135
            h.FormTypeId = cFormTypeId; //7;
           ...
           // h.divWeeklytimetable = divWeeklytimetable;
            ...
            if (!IsPostBack)
            {
                DataTable dt = h.p5Details(EduNewForm);//127);
                if (dt.Rows.Count > 0)
                {
                    DataRow r = dt.Rows[0];
        ...
        protected void W_Click(object sender, EventArgs e)
        {
            ...
            //lvList.Add(tblsign);
            u.ExportIntoOffice(lvList,"WordDocument", "word", style);
        ...
        protected void E_Click(object sender, EventArgs e)
        {
            ...
            u.ExportIntoOffice(lvList, "ExcelDocument", "excel", style);
        }
        ...
        protected void DSMP_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {
            e.Command.Parameters["@EventId"].Value = h.EventId;
            try
            {
