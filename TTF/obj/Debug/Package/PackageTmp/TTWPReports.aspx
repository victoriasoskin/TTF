...
<table>
  ...
  <%--<div id="GridViewDiv" style="overflow-x:auto;width:800px;overflow-y:auto ;visibility:hidden" runat="server">--%> 
   ...
   <%--</div>--%> 
        ...
        <asp:Chart ID="Chart1" runat="server"  DataSourceID="SqlDataSource1" BorderlineColor="Blue" width="650px" OnPrePaint="Chart1_PrePaint" OnLoad="Chart1_Load" OnClick="ChartDrill" >
            <Series>
                <asp:Series Name="Series1" ChartType ="column" YValueMembers="perc" XValueMember="grp" PostBackValue =" #VALX" >
                </asp:Series>
                 <%--<asp:Series Name="Series2" ChartType ="column"  YValueMembers="perc" XValueMember="grp" PostBackValue =" #VALX" >
                </asp:Series>--%>
            </Series>
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1">
                    <AxisX IsReversed="true"></AxisX>
                    <AxisY  Minimum="0" Maximum="4"></AxisY>
                </asp:ChartArea>
            </ChartAreas>
        </asp:Chart>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#Button1").click(function () {
                $("#GridViewDiv").css('visibility', 'visible');
            });
        });
</script>
</asp:Content>
