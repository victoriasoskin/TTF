        ...
        -------------------------- ---%>
            ...
            <InsertItemTemplate>
                ...
                <tr class="editbck">
                    ...
                    <td colspan="9">
                        <asp:TextBox runat="server" ID="tbStrength" Width="600" />
                    </td>
                </tr>
                <tr class="editbck">
                    <td>פעילות פנאי
                    ...
                    <td colspan="9">
                        <asp:TextBox runat="server" ID="tbHobby" Width="600" />
                    </td>
                </tr>
                <tr class="editbck">
                    <td>מסגרת קודמת
                    ...
                    <td colspan="9">
                        <asp:TextBox runat="server" ID="tbPreviousFrame" Width="600" />
                    </td>
                </tr>
                <tr class="editbck">
                    <td>מידע נוסף
                    ...
                    <td colspan="9">
                        <asp:TextBox runat="server" ID="tbOtherInfo" Width="600" />
                    </td>
                </tr>
                <tr>
                        ...
                        <table class="ptbl">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox runat="server" ID="tbPurpose" Columns="100" MaxLength="100" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                        ...
                        <asp:ListView runat="server" ID="dlDetails" OnPreRender="dlDetails_PreRender" InsertItemPosition="FirstItem" OnItemInserting="Det_Inserting" OnItemEditing="lv_ItemEditing" OnItemDeleting="dlDetails_ItemDeleting" OnItemUpdating="Det_Updating">
                            ...
                            <InsertItemTemplate>
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="100" TextMode="MultiLine" Rows="2" Columns="49" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    ...
                                    <td rowspan="3" style="border-bottom: 3px solid gray;">
                                       ...
                                       <asp:TextBox runat="server" ID="tbPeriod" Width="85" MaxLength="50" TextMode="MultiLine" Style="display: none;" OnPreRender="tbOther_PreRender" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                    <td rowspan="3" style="border-bottom: 3px solid gray;">
                                    ...
                                    <td rowspan="3" style="border-bottom: 3px solid gray;">
                                        ...
                                        <br />
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                        <br />
                                    ...
                                    <td rowspan="3" style="white-space: nowrap; border-bottom: 3px solid gray;">
                                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" CommandName="insert" OnPreRender="lnkbSave_PreRender" ValidationGroup="addDet"></asp:LinkButton><asp:LinkButton runat="server" ID="lnkbCancel" Text="ביטול" CssClass="btns" OnClick="lnkbCancel_Click" CausesValidation="false"></asp:LinkButton></td>
                                </tr>
                                <tr style="vertical-align: top;" class="editbck">
                                    <td>יעדים
                                    </td>
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText1" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    ...
                                    <tr style="vertical-align: top;" class="editbck">
                                        ...
                                        <td style="border-bottom: 3px solid gray;">
                                            <asp:TextBox runat="server" ID="tbText2" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                            ...
                            <EditItemTemplate>
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        ...
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="150" TextMode="MultiLine" Rows="4" Columns="49" Text='<%#Eval("Text") %>' onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                    <td rowspan="3">
                                        ...
                                        <asp:TextBox runat="server" ID="tbPeriod" Width="85" MaxLength="40" TextMode="MultiLine" Text='<%#Eval("PeriodText") %>' Style="display: none;" OnPreRender="tbOther_PreRender"  onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')"/>
                                        />
                                    </td>
                                    <td rowspan="3">
                                    ...
                                    <td rowspan="3">
                                        ...
                                        <br />
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" Text='<%#Eval("HelperText") %>' OnPreRender="tbOther_PreRender" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                        <br />
                                        <asp:TextBox runat="server" ID="tbSupporterName" Width="85" MaxLength="40" TextMode="MultiLine" Text='<%#Eval("SupporterName") %>' onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText1" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("text1") %>' onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                </tr>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbText2" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("text2") %>' onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                </tr>
                    ...
                    <td>
                        <table class="ptbl">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="tbPurpose" Columns="100" MaxLength="100" Text='<%#Eval("Purpose") %>'  onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')"/>
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="tbPurpose" ErrorMessage="יש להקליד מטרה" ForeColor="Red" Display="Dynamic" />
                        ...
                        <asp:ListView runat="server" ID="dlDetails" OnPreRender="dlDetails_PreRender" InsertItemPosition="LastItem" DataKeyNames="Id" OnItemEditing="lv_ItemEditing" OnItemDeleting="dlDetails_ItemDeleting" OnItemInserting="Det_Inserting" OnItemCanceling="lv_ItemCanceling" OnItemUpdating="Det_Updating">
                            ...
                            <InsertItemTemplate>
                                ...
                                <tr style="vertical-align: top;" class="editbck">
                                    ...
                                    <td style="">
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                         <asp:RequiredFieldValidator runat="server" ID="rfvDet" ControlToValidate="tbDetails" Display="Dynamic" ErrorMessage="יש להקליד פירוט"  ForeColor="Red" ValidationGroup="addDet" />
                                   </td>
                                    <td rowspan="3">
                                        <asp:DropDownList runat="server" ID="ddlPeriod" AppendDataBoundItems="true" OnDataBinding="ddl_DataBinding" Width="90" OnPreRender="ddl_PreRender"></asp:DropDownList>
                                         <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ControlToValidate="ddlPeriod" Display="Dynamic" ErrorMessage="יש לבחור בתקופה"  ForeColor="Red" ValidationGroup="addDet"/>
                                        <asp:TextBox runat="server" ID="tbPeriod" Width="85" MaxLength="40" TextMode="MultiLine" Style="display: none;" OnPreRender="tbOther_PreRender" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                    <td rowspan="3">
                                        <asp:DropDownList runat="server" ID="ddlFrequesncy_1" AppendDataBoundItems="true" OnDataBinding="ddl_DataBinding" OnPreRender="ddl_PreRender" Width="90">
                                        </asp:DropDownList><br />
                                    ...
                                    <td rowspan="3">
                                        ...
                                        <asp:TextBox runat="server" ID="tbHelper" Width="85" MaxLength="40" Style="display: none;" TextMode="MultiLine" OnPreRender="tbOther_PreRender" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                        <br />
                                        <asp:TextBox runat="server" ID="tbSupporterName" Width="85" MaxLength="40" TextMode="MultiLine" Text="שם הספק" ForeColor="Gray" Font-Italic="true" onfocus="if(this.value == 'שם הספק') {this.value=''; this.style.color = 'black'; this.style.fontStyle = 'normal'; }" onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                            ...
                            <EditItemTemplate>
                                <tr style="vertical-align: top;">
                                    ...
                                    <td style="">
                                        <asp:HiddenField runat="server" ID="hdnId" Value='<%#Eval("Id") %>' />
                                        <asp:TextBox runat="server" ID="tbDetails" MaxLength="150" TextMode="MultiLine" Rows="2" Columns="49" Text='<%#Eval("Text") %>' onkeypress="if (this.value.length==this.getAttribute('maxlength')) alert('לא ניתן להקליד עוד')" />
                                    </td>
                                    <td rowspan="3">
