            ...
            <EditItemTemplate>
                <tr>
                    <td colspan="5" class="pEhdr">עריכת תמיכה מספר <%#Eval("Ln") %>
                        <asp:LinkButton runat="server" ID="lnkbSaveClose" Text="שמירה וסגירה" CssClass="btns" OnClick="lnkbWP_Click"></asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkbSave" Text="שמירה" CssClass="btns" OnClick="lnkbWP_Click"></asp:LinkButton>
                        <asp:LinkButton runat="server" ID="lnkbCancel" Text="ביטול" CssClass="btns" CommandName="cancel" OnClick="lnkbCancel_Click" CausesValidation="false"></asp:LinkButton></td>
                </tr>
                <asp:HiddenField runat="server" ID="hdnWPId" Value='<%#Eval("Id") %>' />
                </td>
                </tr>
