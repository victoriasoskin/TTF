                        ...
                        <table style="width: 100%; font-size: small;">
                            <tr>
                                <td colspan="6" style="text-align: center;">
                                    <span style="font-size: xx-large; font-weight: bold;"><%#"מעקב תמיכות דיור - " + Eval("Name") %></span>
...
<%--                        <%#Eval("Q4") %>--%>
    ...
    <asp:SqlDataSource runat="server" ID="DSDetReport" ConnectionString="<%$ ConnectionStrings:Book10PE %>"
        SelectCommand="SELECT Id ,FormId ,EventId ,CustomerId ,WpId ,DetailsId ,val ,Text ,u.UserId ,URName ,LoadTime 
                                                    FROM Book10.dbo.TT_WP_Reports r
                                                    LEFT OUTER JOIN Book10_21.dbo.p0t_NtB u ON u.UserId = r.UserId
                                                    WHERE  DetailsId = @DetailsId And EventId = @EventId
        ...
        <SelectParameters>
            <asp:QueryStringParameter Name="DetailsId" QueryStringField="RId" Type="Int32" DefaultValue="1" />
