...
namespace TTF
{
    public partial class TTfup_p : System.Web.UI.Page
    {
        ...
        protected void chrt_OnPrePaint(object sender, System.EventArgs e)
        {
            ...
            //{
            //    System.Web.UI.DataVisualization.Charting.DataPoint p = srs.Points[0];
        ...
        {
            e.Command.Parameters[1].Value = h.CustomerId;
            e.Command.Parameters[2].Value = cFormTypeId;
        }
        ...
        protected void MiniGraph_PreRender(object sender, EventArgs e)
        {
            ...
            int e1 = h.EventId;
            HiddenField hdwp = (HiddenField)lvi.FindControl("hdnWPId");
            h.WpId =int.Parse( hdwp.Value); // h.getWpId(lvi.DisplayIndex);
