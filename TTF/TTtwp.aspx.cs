...
namespace TTF
{
    public partial class TTtwp : System.Web.UI.Page
    {
        TTF.App_Code.bpHelber h;
        TTF.App_Code.Util u;
        const int cCustEventTypeId = 140;
        ...
        protected void ddl_PreRender(object sender, System.EventArgs e)
        {
            ...
            if (ddl.SelectedValue == string.Empty)
            {
                ...
                {
                    HiddenField hdn = (HiddenField)lvi.FindControl("hdn" + ddl.ID.Substring(cFormTypeId));
                    if (hdn != null)
                    {
        ...
        protected void chrt_Drill(object sender, ImageMapEventArgs e)
        {
            ...
            string sql = string.Format("SELECT grp,perc FROM (" +
                                        ...
                                        "Order By Ord", s, hdnForm139.Value);
